...
class Frontend
{
	public static function onEndBufferContent(&$content): void
	{
		...
		// Avoid double inject (must match assignment, not mere mentions like window.PRIME_ALERTS.sessid)
		...
		$jsHref = '/local/modules/prime.alerts/assets/policy.js?v=1.5.23';
		$flash = '';
		try {
