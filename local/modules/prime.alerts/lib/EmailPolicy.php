...
class EmailPolicy
{
	...
	{
		$email = trim(Config::get('support_email', 'info@metprof-vrn.ru')) ?: 'info@metprof-vrn.ru';
		$phone = trim(Config::get('support_phone', '+7 (473) 234-03-01')) ?: '+7 (473) 234-03-01';
		$tel = preg_replace('/\D+/', '', $phone) ?: '74732340301';
