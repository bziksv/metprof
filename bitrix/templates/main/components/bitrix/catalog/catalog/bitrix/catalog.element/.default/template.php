              ...
              <? if(empty($arOffers['DISCOUNT_VALUE'])): ?>
                  <div class="bb_col">
                      <div class="price">
                              ...
                              <div class="price-new">
								<span><?=$arOffers['BASE_PRICE'] ?: priceDiscount($arResult['ID']);?></span>  
								<?=RUB?>/<?=$arResult['PROPERTIES']['CML2_BASE_UNIT']['VALUE'];?>
							  </div>
                      </div>
                  </div>
...
<?}?>
	...
	?>
     ...
     <div class="p-view__param-col p-view__param-col_restyled">
        ...
        <div class="p-view__param-box prodcap data-square">
            ...
            <div class="b-select_help_new_upplace">Под заказ по вашим размерам</div>
                ...
                <div class="b-fast-buy">
                    <!-- <div class="b-fast-buy-input">
                        <div class="block-input-phone">
                            <input class="forminput fast-buy-phone-number" type="text" id="fast-buy-phone-number" placeholder="+7 (___) ___-__-__"  name="fast-buy-phone-number">
                        </div>
                    </div> -->
                    <div class="b-fast-buy-button" style="float: none;">
                        <a class="button button-primary button-block text-center fast-buy-visible phone-ord-send-button" style="width: 100%;" href="" id="phone-ord-send-button">Перезвоните мне сейчас!</a>
                    </div>
                </div>
            </div>
            <div class="clear"></div>
    ...
    <?else:?>
        ...
        <? if (!$arResult['HAS_RECOMMENDED']):
            $sameProductSidebar = true;
            include __DIR__ . '/same_product_inc.php';
        endif; ?>
   ...
   <div class="cl"></div>
    ...
    <div class="col-show-slides-6">
        ...
        <? if ($arResult['IS_M2'] || $arResult['HAS_RECOMMENDED']):
            $sameProductSidebar = false;
            include __DIR__ . '/same_product_inc.php';
        endif; ?>
