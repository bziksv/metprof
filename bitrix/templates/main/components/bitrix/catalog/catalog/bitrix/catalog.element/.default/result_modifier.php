...
$seoDescription = '';
if (!empty($arResult['PROPERTIES']['SEO_DESCRIPTION']['VALUE']))
{
	if (!empty($arResult['PROPERTIES']['SEO_DESCRIPTION']['~VALUE']['TEXT']))
	{
		$seoDescription = $arResult['PROPERTIES']['SEO_DESCRIPTION']['~VALUE']['TEXT'];
	}
	elseif (!empty($arResult['PROPERTIES']['SEO_DESCRIPTION']['~VALUE']))
	{
		$seoDescription = is_array($arResult['PROPERTIES']['SEO_DESCRIPTION']['~VALUE'])
			? ($arResult['PROPERTIES']['SEO_DESCRIPTION']['~VALUE']['TEXT'] ?? '')
			: $arResult['PROPERTIES']['SEO_DESCRIPTION']['~VALUE'];
	}
}

if ($seoDescription !== '')
{
	$arResult['DETAIL_TEXT'] = $seoDescription;
}
