...
<div class="row">
    ...
    <div class="letters">
        <?if(count_all($arResult['FILTER_LITTER']['int'])):?>
        ...
        <?if(count_all($arResult['FILTER_LITTER']['str_eng'])):?>
            <ul class="letter-list">
        ...
        <?if(count_all($arResult['FILTER_LITTER']['str_rus'])):?>
            <ul class="letter-list">
