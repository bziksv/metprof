					...
					switch ($group['NAME']) {
						...
						case "phone_group_fis":
							...
							<div class="line ph">
								...
								$num = array(); // Инициализируем массив
								...
								<? // Исправленная строка с проверкой на массив для PHP 8+ ?>
								<? foreach(array_slice((is_array($num) ? $num : []), 1) as $number): ?>
									<? if(strlen($number) > 2): ?>
									<div class="phone-add first">
										<div class="inp phone">
...
<div class="or__content cl s2">
	...
	<div class="methods cl">
		<?
		$name_field_store = "";
		if (is_array($arResult['PRINT_PROPS_FORM']['USER_PROPS_Y'])) {
